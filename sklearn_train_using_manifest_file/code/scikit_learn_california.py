...
if __name__ == "__main__":
    ...
    print_files_in_dir(args.training)

    # Train data
    training_dir = os.path.join(args.training, "train")
    print_files_in_dir(training_dir)
    ...
    # Validation data
    validation_dir = os.path.join(args.training, "validation")
    print_files_in_dir(validation_dir)
    input_files = [os.path.join(validation_dir, file) for file in os.listdir(validation_dir)]
    raw_data = [pd.read_csv(file, header=None, engine="python") for file in input_files]
